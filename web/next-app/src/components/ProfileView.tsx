      ...
      >
        ...
        <div className='relative max-w-2xl mx-auto flex items-start justify-between'>
          <div>
            ...
            <h1 className='font-editorial text-3xl text-[var(--text-secondary)] leading-tight'>
                    ...
                    return (
                      <button
                        ...
                        className={
                          ...
                          (isSelected
                            ? 'border-[var(--accent)] bg-[var(--accent-bg)] text-[var(--text-secondary)] font-medium'
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (isActive
                      ? 'border-[var(--accent)] bg-[var(--accent-bg)] text-[var(--text-secondary)]'
                      : 'border-[var(--border)] text-[var(--text-muted)] hover:border-[var(--accent)] hover:text-[var(--text-secondary)]')
                  }
                >
    ...
    <div className='mb-3'>
      ...
      {items.length > 0 && (
        <div className='flex flex-wrap gap-1.5 mb-2'>
          {items.map((it) => (
            <span key={it} className='inline-flex items-center gap-1 px-2 py-0.5 text-xs rounded-md border border-[var(--accent)] bg-[var(--accent-bg)] text-[var(--text-secondary)]'>
              {it}
